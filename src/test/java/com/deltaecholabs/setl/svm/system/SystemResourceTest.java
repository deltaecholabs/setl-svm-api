...
public class SystemResourceTest {
    ...
    public void postFailNoName() {
        System system = new System(null, RandomStringUtils.randomAlphabetic(5), null);
        given()
                .contentType(ContentType.JSON)
                .body(system)
                .post("/systems")
    ...
    private System createSystem() {
        return new System(null, RandomStringUtils.randomAlphabetic(10), RandomStringUtils.randomAlphabetic(10));
    }
}